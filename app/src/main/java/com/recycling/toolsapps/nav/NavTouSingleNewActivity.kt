...
import com.recycling.toolsapps.databinding.NavTouSingleActivityBinding
import com.recycling.toolsapps.fitsystembar.showSystemBar
import com.recycling.toolsapps.http.TaskRestartScheduler
...
import com.recycling.toolsapps.socket.RestartBean
import com.recycling.toolsapps.utils.CmdValue
import com.recycling.toolsapps.utils.CommandParser
...
import com.recycling.toolsapps.vm.NewDualUsbCameraManager.CameraErrorListener
import com.serial.port.t.CmdEnumText
            ...
            cabinetVM.state.collect {
                ...
                when (it) {
                    ...
                    CabinetVM.ConnectionState.CONNECTED -> {
                        ...
                        val loginCount =
                            SPreUtil[AppUtils.getContext(), SPreUtil.loginCount, 0] as Int
            ...
            cabinetVM.incoming?.collect { bytes ->
                ...
                when (cmd) {
                    ...
                    CmdValue.CMD_PHONE_NUMBER_LOGIN -> {
                        ...
                        //处理处理两个格口的问题
                        val mobileDoorGeX =
                            SPreUtil[AppUtils.getContext(), SPreUtil.mobileDoorGeX, 1]
...
//                        cabinetVM.startDowChip(otaModel)
                    ...
                    CmdValue.CMD_ADMIN_OVERFLOW -> {
                        val adminOverflowModel =
                            Gson().fromJson(json, AdminOverflowBean::class.java)
    ...
    private fun refreshHomeRes() {
        ...
        cabinetVM.mHomeBg?.let { bitmap ->
            ...
            if (cabinetVM.mHomeBg == null) {
                val resBitmap =
                    BitmapFactory.decodeResource(AppUtils.getContext().resources, R.drawable.home)
